...
| :----------------------------------------------------- | :----------------------------------------------------------------------------------- | :---------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Grid Emission Factors                                  | Annual electricity mix from national grids                                           | Annually                      | Yearly electricity data from EMBER: https://ember-climate.org/data/data-catalogue/  - see https://github.com/EPFL-ENAC/unhcr-geneva-tech-hub-app/issues/634)                                                                                           | `reference-data/ghg/ghg_grid_emission_factors.csv`          | `frontend/src/assets/references/ghg_grid_emission_factors.json`                                                                           | `frontend/src/store/GhgModule.ts` via `frontend/src/store/GhgReferenceGridModule.ts`                                                                                                                  |
| Emission Factors - global                              | Emission factors for all 5 GHG modules                                               | None                          | Processed EFs from literature including from IPCC, FACET, see hyperlinks on GHG Tool.                                                                                                                                                                  | `reference-data/ghg/ghg_emission_factors.csv`                  | `frontend/src/assets/references/ghg_emission_factors.json`                                                                                   | `frontend/src/store/GhgReferenceModule.ts`                                                                                                                                                            |
