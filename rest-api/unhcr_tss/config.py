...
settings = Dynaconf(
    ...
    validators=[
        ...
        Validator("MAIL_STARTTLS", must_exist=False, default=false),
        Validator("MAIL_SSL_TLS", must_exist=False, default=false),
        Validator("USE_CREDENTIALS", must_exist=False, default=false),
