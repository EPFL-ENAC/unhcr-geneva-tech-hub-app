  ...
  get shelterHelpers(): Helpers[] {
    return [
      ...
      },
      {
        ...
        icon: "mdiPlayCircle",
        type: "video",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Viewing existing projects.mp4`,
      },
      {
        title: "Creating new projects",
        icon: "mdiPlayCircle",
        type: "video",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Creating new projects.mp4`,
      },
      {
        title: "Entering project information",
        icon: "mdiPlayCircle",
        type: "video",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Entering project information.mp4`,
      },
      {
        title: "Uploading and downloading project files",
        icon: "mdiPlayCircle",
        type: "video",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Uploading and downloading project files.mp4`,
      },
      {
        ...
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Entering geometry information.mp4`,
      },
      {
        title: "Entering Bill of Quantities information",
        icon: "mdiPlayCircle",
        type: "video",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Entering BOQ information.mp4`,
      },
      {
        title: "Assessing technical performance criteria",
        icon: "mdiPlayCircle",
        type: "video",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Assessing technical performance.mp4`,
      },
      {
        title: "Assessing habitability criteria",
        icon: "mdiPlayCircle",
        type: "video",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Assessing Habitability.mp4`,
      },
      {
        ...
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Comparing projects.mp4`,
      },
      {
        ...
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Exporting reports.mp4`,
      },
      {
        ...
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Viewing overview data.mp4`,
      },
      {
        ...
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-27/Viewing reference data.mp4`,
      },
    ];
  }
  ...
  get GHGHelpers(): Helpers[] {
    return [
      ...
      },
      {
        ...
        type: "video",
        icon: "mdiPlayCircle",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-11-23/Introduction to GHG Calculation Tool.mp4`,
      },
      {
        title: "GHG Databases and Creating Assessments",
        type: "video",
        icon: "mdiPlayCircle",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-11-23/GHG Databases and Creating Assessments.mp4`,
      },
      {
        title: "Energy for Facilities Tutorial (Coming soon)",
        type: "video",
        icon: "mdiPlayCircle",
        // href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-11-23/{comingsoon}.mp4`,},
      },
      {
        title: "Energy for Cooking Tutorial",
        type: "video",
        icon: "mdiPlayCircle",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-11-23/Energy for Cooking Tutorial.mp4`,
      },
      {
      ...
      },
      {
        ...
        type: "video",
        icon: "mdiPlayCircle",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-11-23/Water Supply Tutorial.mp4`,
      },
      {
        title: "Domestic Solid Waste Tutorial",
        type: "video",
        icon: "mdiPlayCircle",
        href: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-11-23/Domestic Solid Waste Tutorial.mp4`,
      },
      {
