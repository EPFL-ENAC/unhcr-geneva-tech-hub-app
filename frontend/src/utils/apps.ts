...
export const ghg = {
  ...
  to: "GreenHouseGaz",
  link: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-11-23/GHG tool User's Manual v6.pdf`,
...
export const shelter = {
  ...
  link: `${env.VUE_APP_AZURE_CONTAINER_PREFIX}/2023-03-15/Shelter & Sustainability Manual_230312.pdf`,
  linkName:
