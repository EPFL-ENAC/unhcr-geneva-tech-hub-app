      ...
      children: [
        {
          _id: "input12",
          label:
            "Artificial lighting is provided inside shelter (determined by technical performance response)",
          disabled: true,
          // nonApplicable: true,
          description:
        ...
        },
        {
          ...
          disabled: true,
          label:
            "Artificial lighting is provided around shelter (determined by technical performance response)",
          // nonApplicable: true,
          description:
