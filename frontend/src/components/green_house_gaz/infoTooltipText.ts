...
export const infoTooltipText: Record<string, tooltipInfo> = {
  ...
  "WASH-WaterSupply": {
    title: "Water supply",
    ready: true,
    text: "The WASH watersupply module calculates the emissions that are generated by trucking volumes of either water, wastewater or faecal sludge. Emission factors consider a medium sized diesel truck round trips on the settlement sites.",
  },
  "Material-Shelter": {
