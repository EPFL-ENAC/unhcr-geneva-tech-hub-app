<template>
  <v-container fluid>
    ...
    <survey-item-default-form :form="form" @update:form="updateCurrentSurvey" />
  </v-container>
</template>
...
@Component({
  components: {
    SurveyItemDefaultForm,
    SurveyItemTitle,
  },
})
export default class HHWasteWater extends Vue {
  ...
  public updateCurrentSurvey(newForm: FormSurvey): void {
