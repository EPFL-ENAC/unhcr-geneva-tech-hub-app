...
export default class Pumping extends Vue {
  ...
  public set localForm(value: WashPumpingSurvey) {
    this.$emit("update:form", value);
  }

  private computeItemElectric(
    localItemInput: WashPumpingItemInput,
  ...
  private computeTotalPower(localItemInput: WashPumpingItemInput): number {
    let totalPower =
  ...
  resetSurveyInput(localInput: WashPumpingItemInput): WashPumpingItemInput {
    ...
    return [
      ...
      },
      {
        ...
        customEventInput: (
          ...
          localInput: WashPumpingItemInput
        ) => {
...
export interface WashPumpingItemInput
  extends DieselItem,
    EnergyItem,
    SurveyInput {
...
export interface WashPumpingItemResults extends SurveyResult {
  totalCO2Emission: number;
}
export interface WashPumpingItem extends SurveyItem {
  input: WashPumpingItemInput;
  computed: WashPumpingItemResults;
}

export interface WashPumpingItemResultsBalance extends SurveyResult {
  totalCO2Emission: number;
  changeInEmission: number;
}
export interface WashPumpingItemResultsWithBalance
  extends WashPumpingItemResults,
    WashPumpingItemResultsBalance {}

export type WashPumpingSurvey = GenericFormSurvey<
  WashPumpingItem,
  WashPumpingItemResults,
  WashPumpingItem,
  WashPumpingItemResultsWithBalance
>;
</script>
