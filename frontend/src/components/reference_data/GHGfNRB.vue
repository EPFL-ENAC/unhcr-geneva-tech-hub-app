    ...
    <v-card-text v-if="items">
      <v-row>
        <v-col>
          ...
          For the countries that are not listed in the database, the default value for fNRB is 30%.
          <br/>The source for this value is this methodology tool:
          <a target="_blank" src="https://cdm.unfccc.int/methodologies/PAmethodologies/tools/am-tool-30-v1.pdf"
